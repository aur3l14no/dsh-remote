...
try {
  ...
  const config = JSON.parse(await readFile('tests/integration/cordis.yml', 'utf8'));
  ...
  const otherConfig = JSON.parse(await readFile('tests/integration/cordis.yml', 'utf8'))[0];
