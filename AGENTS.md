...
- Keep Cargo.lock at the workspace root; root Cargo commands emit to runtime/helper/target/ via .cargo/config.toml. Update imports, manifests, scripts and reproducible checks when moving code.
