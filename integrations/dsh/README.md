...
- `plugins/`: `extension/src/index.ts` is the host composition entry; other modules own World providers, portable_workspace, admission, skills, account policy, file references, previews and terminal integration.
