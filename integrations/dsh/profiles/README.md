...
| remote preset | Isolated FS/subprocess/shell/workdir services; native read/write/edit, grep/glob, foreground/background Bash, jobs, Web/skill tools and remote instructions |
