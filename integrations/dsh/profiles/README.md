...
Add runnable config only after Loader + cold activation + browser acceptance. See [execution boundaries](../../../docs/execution-boundaries.md) and [phase plan](../../../.agents/notes/proposed/integration/2026-09-07-world-project-web.md).
