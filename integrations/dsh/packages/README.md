...
Use kebab-case for new source paths, camelCase for TypeScript values, and PascalCase for types. Installed module identities must remain consistent within the built bundle. Historical test/evidence names need not follow source renames.
