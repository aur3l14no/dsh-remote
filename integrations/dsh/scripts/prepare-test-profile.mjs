...
execFileSync(process.execPath, ['--expose-internals', join(installation, 'node_modules/@deepseek-ai/dsh/lib/bin.js'), 'plugin', '--profile', 'web', 'add', resolve('target/packages/dsh-remote-extension-0.2.0.tgz')], { env: { ...process.env, DSH_HOME: home }, stdio: 'inherit' });
