...
try {
  ...
  const child = spawn(process.execPath, ['.build/dsh/composition/portable_workspace.mjs'], { stdio: ['ignore', 'pipe', 'pipe'],
...
await writeFile('artifacts/dsh/portable_workspace-acceptance.json', JSON.stringify({ schema: 1, started, completed: new Date().toISOString(),
