...
for (const [from, to] of [['local-workspace.e2e.ts', 'local-workspace.e2e.ts'], ['attachments.e2e.ts', 'attachments.e2e.ts'], ['session-migration.ts', 'remote-session-migration.ts'], ['file-preview.ts', 'remote-file-preview.ts'], ['portable-workspace.e2e.ts', 'portable-workspace.e2e.ts'], ['live.e2e.ts', 'remote-live.e2e.ts'], ['children.ts', 'remote-children.ts'], ['replay.ts', 'remote-replay.ts']]) {
