...
for (const [from, to] of [['session-migration.ts', 'remote-session-migration.ts'], ['file-preview.ts', 'remote-file-preview.ts'], ['portable-workspace.e2e.ts', 'portable-workspace.e2e.ts'], ['live.e2e.ts', 'remote-live.e2e.ts'], ['children.ts', 'remote-children.ts'], ['replay.ts', 'remote-replay.ts']]) {
