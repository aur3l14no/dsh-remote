...
for (const [before, after] of [
  ...
  ["{ id: 'llm-deepseek', disabled: true }", "{ id: 'remote-llm-deepseek', disabled: true }"],
...
for (const [from, to] of [['attachments.e2e.ts', 'attachments.e2e.ts'], ['session-migration.ts', 'remote-session-migration.ts'], ['file-preview.ts', 'remote-file-preview.ts'], ['portable-workspace.e2e.ts', 'portable-workspace.e2e.ts'], ['live.e2e.ts', 'remote-live.e2e.ts'], ['children.ts', 'remote-children.ts'], ['replay.ts', 'remote-replay.ts']]) {
