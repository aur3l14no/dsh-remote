...
Other fixtures cover provider composition, Session routing, Agents and terminal consumers. Commands and required environment inputs are in [development](../../../../docs/development/README.md). Patched-host checks live separately in `../patched-host/`; official installation and browser/SSH acceptance are under `../packaging/` and `../e2e/`.
