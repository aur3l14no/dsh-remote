...
This Rust crate implements the remote runtime protocol: filesystem operations, managed processes, pipes, PTY, signals, cancellation, bounded output and finite live-runtime reconnection. It has no DSH, Project, Agent, skill or tool policy dependency.
