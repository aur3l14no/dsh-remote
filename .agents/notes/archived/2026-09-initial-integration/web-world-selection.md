...
Deferred product flow based on unchanged DSH `d347e703908d0406b7a7ef80e3a0e594d86b2215`. A [source-only Project experiment](../../../../integrations/dsh/experiments/project-worlds/README.md) validates the service and entry wiring. Settings/UI and transparent Web activation are not implemented, and their development is paused.
