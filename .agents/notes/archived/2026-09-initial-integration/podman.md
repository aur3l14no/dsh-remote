...
These remain source-built DSH fixtures. They do not establish complete Web compatibility, model-driven cross-root orchestration or shared-router terminal initialization; see [demo assessment](2026-09-07-decisions.md).
